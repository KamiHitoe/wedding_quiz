  ...
  <div>
    <div class="container">
      <div class="quiz-title">
        <h2>Q5. 新婦がスターバックスで<br>一番注文するものは？</h2>
      </div>
      <div class="flex-container">
        <div class="flex-item1">
          <div class="middle-img">
            <img src="../assets/wedding_quiz07.jpg">
          </div>
          <div class="quiz-selection">
            <h3>1. 抹茶クリーム<br>フラペチーノ</h3>
          </div>
        </div>
        <div class="flex-item2">
          <div class="middle-img">
            <img src="../assets/wedding_quiz08.jpg">
          </div>
          <div class="quiz-selection">
            <h3>2. マンゴーパッション<br>フラペチーノ</h3>
          </div>
        </div>
        <div class="flex-item3">
          <div class="middle-img">
            <img src="../assets/wedding_quiz09.jpg">
          </div>
          <div class="quiz-selection">
            <h3>3. コーヒー<br>フラペチーノ</h3>
          </div>
        </div>
...
export default {
  ...
  methods: {
    postAnswer() {
      ...
      if (this.$store.state.answerArray.length > 4) {
        this.$store.state.answerArray.splice(4, 1, this.number);
      } else {
        this.$store.state.answerArray.splice(4, 0, this.number);
      }
    },
