  ...
  <div>
    <div class="container">
      <div class="quiz-title">
        <h2>Q8. 新郎が一番好きな<br>京アニの映画は？</h2>
      </div>
      <div class="flex-container">
        <div class="flex-item1">
          <div class="middle-img">
            <img src="../assets/wedding_quiz15.jpg">
          </div>
        ...
        <div class="flex-item2">
          <div class="middle-img">
            <img src="../assets/wedding_quiz16.jpg">
          </div>
          <div class="quiz-selection">
            <h3>2. ヴァイオレット・<br>エヴァーガーデン</h3>
          </div>
        </div>
        <div class="flex-item3">
          <div class="middle-img">
            <img src="../assets/wedding_quiz17.jpg">
          </div>
          <div class="quiz-selection">
            <h3>3. たまこまーけっと</h3>
          </div>
...
export default {
  ...
  methods: {
    postAnswer() {
      ...
      if (this.$store.state.answerArray.length > 7) {
        this.$store.state.answerArray.splice(7, 1, this.number);
      } else {
        this.$store.state.answerArray.splice(7, 0, this.number);
      }
    },
